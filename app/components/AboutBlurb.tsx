        ...
        <div className={"px-10 flex-row py-10 bg-slate-900"}>
            ...
            <div className={"flex flex-col sm:flex-row h-96 gap-x-4 sm:gap-y-4"}>
                <div className={"relative flex-1"}>
                    <Image src={"/team114.jpg"} alt={"robotwork"} fill={true} style={{objectFit: 'contain'}}
                           quality={100}/>
                </div>
                ...
                >
                    ...
                    <p>Team 114, also known as Eaglestrike, is the official robotics team of Los Altos High School.
                        Founded
                        in 1997, Eaglestrike was one of the first teams to be part of the FIRST Robotics Competition
                        (FRC)
                        series.</p>
                </motion.div>
            </div>
            <div className={"w-full justify-end flex mt-4"}>
                <a className={"inline-flex flex-row p-4 py-3 bg-white hover:bg-blue-600 rounded-full group justify-center items-center gap-x-3"}
                   href={"/about"}>
