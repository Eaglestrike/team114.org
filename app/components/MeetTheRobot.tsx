            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-2">
                        Meet <span className="font-mono text-blue-400">SN00PY</span>
                    </h2>
                    <p className="text-sm font-mono uppercase text-gray-400">Our 2024 Robot</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    <FeatureCard
                        ...
                        title="Swerve Drive"
                        description="Advanced mobility and precision control"
                    />
                    <FeatureCard
