	...
	if (side === 'right') {
		return (
			<div className={'flex flex-col sm:flex-row w-screen h-full py-2'}>
				...
				<div className={`flex flex-row flex-1 grid-cols-1`} style={{ justifyContent: 'flex-start' }}>
					<div className={'mx-9 flex w-fill items-center justify-center'}>
						<motion.div
							className={'lg:pb-52 sm:pb-3'}
							initial={{ x: 100 }}
							whileInView={{ x: 0 }}
						...
						>
							<p
								className={
									'grow mb-8 text-5xl font-bold text-left text-slate-100 underline underline-offset-8 decoration-4'
								}
							>
								{text1}
							</p>
